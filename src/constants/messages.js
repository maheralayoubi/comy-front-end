...
export const invalidPasswordMsg = "パスワードは8文字以上で、数字と大文字を含む必要があります。";
...
export const verifyEmailMsg = "ログインする前にメールアドレスを確認してください。";
export const serverErrorMsg = "内部サーバーエラーが発生しました。後ほど再度お試しください。";
