...
import { TextArea, Input, Fonts, Themes, UploadImage } from '../components/FormElements';
...
const BusinessSheetCreation = () => {
    ...
    const [businessSheetData, setBusinessSheetData] = useState({
        ...
        "backgroundImage": getValue("backgroundImage") || "/images/backgroundImage.png",
    })
    ...
    return (
        <>
            ...
            <Stepper data={businessSheetData}>
                ...
                <Step title="カスタマイズ">
                    <UploadImage title="ヘッダー背景画像を設定してください" value={businessSheetData.coverImage} onChange={handleChange} name="coverImage" setBusinessSheetData={setBusinessSheetData} />
                    <UploadImage title="プロフィール画像を設定してください" value={businessSheetData.profileImage} onChange={handleChange} name="profileImage" setBusinessSheetData={setBusinessSheetData} />
                    <UploadImage title="リファーラルシートの背景画像をアップロードしてください" value={businessSheetData.backgroundImage} onChange={handleChange} name="backgroundImage" setBusinessSheetData={setBusinessSheetData} />
